...
_$WaterSystemStateImpl _$$WaterSystemStateImplFromJson(
  ...
  detectedFault: json['detectedFault'] as String? ?? '',
  autoActionLog: json['autoActionLog'] as String? ?? '',
  failoverActive: json['failoverActive'] as bool? ?? false,
...
Map<String, dynamic> _$$WaterSystemStateImplToJson(
  ...
  'detectedFault': instance.detectedFault,
  'autoActionLog': instance.autoActionLog,
  'failoverActive': instance.failoverActive,
